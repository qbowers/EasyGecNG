 ...
 *
 */
public class HtmlResultatDetaille
{
  public static void exporterHtml(EasyGec easyGec, String fichier)
  {
    ...
    try
    {
      ...
      tampon.append(easyGec.getResultatsCircuitDetailleToHtml());
  ...
  public static void exporterHtmlParIdentifiant(EasyGec easyGec, String fichier)
  {
    ...
    try
    {
      ...
      StringBuffer tampon = new StringBuffer();
      tampon.append("<html><style>td {padding: 10px;}</style><body><h1>Résultats détaillés par identifiant</h1>");
      tampon.append(easyGec.getResultatsDetailleIdentifiantToHtml());
      tampon.append("</body></html>");
